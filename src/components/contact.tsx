      ...
      <div className="container mx-auto">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
          ...
          <div className="flex flex-col gap-6">
            <div>
              <h2 className="text-2xl font-semibold tracking-tight sm:text-3xl">დაგვიკავშირდით</h2>
          ...
          <div className="rounded-xl border border-border bg-background p-6 sm:p-8">
            {state.status === 'success' ? (
              <div className="flex flex-col items-center gap-3 py-8 text-center">
                ...
                <p className="font-medium">შეტყობინება გაიგზავნა!</p>
                <p className="text-sm text-muted-foreground">მადლობა, ჩვენ მალე დაგიკავშირდებით.</p>
              </div>
            ) : (
